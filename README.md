...
>
> MVC-фреймворк разработан для эффективного использования веб-приложения способом разделения веб-приложения на отдельные молули (и эти модули разносятся на отдельные компьютеры... - это приводит к увеличению общей производительности)
>
>
