...
import com.uibinder.moradan.client.event.*;
import com.uibinder.moradan.client.rpc.ContactsServiceAsync;
import com.uibinder.moradan.client.view.ContactListViewImpl;
import com.uibinder.moradan.client.view.ContactPersonViewImpl;

public class AppController implements Presenter, ValueChangeHandler<String> {
	private final EventBus               eventBus;
	private final ContactsServiceAsync rpcService;
	private HasWidgets                  container;
	private ContactListViewImpl contactsView = null;
	private ContactPersonViewImpl editContactView = null;

	public AppController(ContactsServiceAsync rpcService, EventBus eventBus) {
		...
		if (token != null) {
			if (token.equals("list")) {
				...
				GWT.runAsync(new RunAsyncCallback() {
					...
					@Override
					public void onSuccess() {
						new ContactPersonPresenter(rpcService, eventBus, getEditContactView()).
								go(container);
					}
				});
